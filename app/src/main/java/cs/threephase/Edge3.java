...
class Edge3 {
    ...
    static int[] eprun = null;//new int[N_EPRUN / 16];
    ...
    void move(int i) {
        ...
        switch (i) {
            ...
            case 14:	//u2
                swap(edge, 0, 4, 1, 5);
                swap(edgeo, 0, 4, 1, 5);
                Utils.swap(edge, 9, 11);
                Utils.swap(edgeo, 8, 10);
                break;
            case 15:	//r2
                swap(edge, 5, 10, 6, 11);
                swap(edgeo, 5, 10, 6, 11);
                Utils.swap(edge, 1, 3);
                Utils.swap(edgeo, 0, 2);
                break;
            case 16:	//f2
                swap(edge, 0, 11, 3, 8);
                swap(edgeo, 0, 11, 3, 8);
                Utils.swap(edge, 5, 7);
                Utils.swap(edgeo, 4, 6);
                break;
            case 17:	//d2
                swap(edge, 2, 7, 3, 6);
                swap(edgeo, 2, 7, 3, 6);
                Utils.swap(edge, 8, 10);
                Utils.swap(edgeo, 9, 11);
                break;
            case 18:	//l2
                swap(edge, 4, 8, 7, 9);
                swap(edgeo, 4, 8, 7, 9);
                Utils.swap(edge, 0, 2);
                Utils.swap(edgeo, 1, 3);
                break;
            case 19:	//b2
                swap(edge, 1, 9, 2, 10);
                swap(edgeo, 1, 9, 2, 10);
                Utils.swap(edge, 4, 6);
                Utils.swap(edgeo, 5, 7);
                break;
        }
    }
