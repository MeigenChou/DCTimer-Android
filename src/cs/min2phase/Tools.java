...
public class Tools {
    ...
    public static void init() {
        ...
        try {
        	InputStream in = new BufferedInputStream(new FileInputStream(DCTimer.dataPath + "twophase.dat"));
			...
			Search.init();
			try {
				OutputStream out = new BufferedOutputStream(new FileOutputStream(DCTimer.dataPath + "twophase.dat"));
