...
final class Center1 {
	...
	//static File file=new File(Environment.getExternalStorageDirectory(),"Center1");
...
//		if (!read(ctsmv, 0, 15582, 36, "Center1")) {
//			createMoveTable();
//			write(ctsmv, 0, 15582, 36, "Center1");
//		}	
		read(ctsmv, 0, 15582, 36, "/mnt/sdcard/DCTimer/Center1");
