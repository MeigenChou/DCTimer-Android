...
public class FullCube implements Comparable {
	...
	public FullCube(byte[] edge, byte[] center, byte[] cp, byte[] co){
		this.edge=new EdgeCube(edge);
		this.center=new CenterCube(center);
		this.corner=new CornerCube(cp,co);
	}
...
//		for(int i=0; i<24; i++)System.out.print(edge.ep[i]+" ");
//		System.out.println();
//		for(int i=0; i<24; i++)System.out.print(center.ct[i]+" ");
//		System.out.println();
//		for(int i=0; i<8; i++)System.out.print(corner.cp[i]+" ");
//		for(int i=0; i<8; i++)System.out.print(corner.co[i]+" ");
//		System.out.println();
	}
